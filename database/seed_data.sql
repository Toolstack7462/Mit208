...
-- Users -----------------------------------------------------------------
INSERT INTO users (email, full_name, hashed_password, role, is_active) VALUES ('admin@phishguard.local', 'Alex Admin', '$2b$12$TnNZizFZU4MUUhlxufgsIulC2vJ2qWXhnUDmezAn0AfNijiBc4K2G', 'admin', TRUE);
INSERT INTO users (email, full_name, hashed_password, role, is_active) VALUES ('analyst@phishguard.local', 'Sam Analyst', '$2b$12$LFUOGpgflbEdLzuTPLEcz.KfbNn5.3sc5.609JjitbRtaZAcG42Oe', 'analyst', TRUE);
INSERT INTO users (email, full_name, hashed_password, role, is_active) VALUES ('staff@phishguard.local', 'Riley Staff', '$2b$12$Kb5El7xjNo9qdI3PEZSATOpp1idP9OzRMSJVIPzy6tUdxcpIHbUH.', 'staff', TRUE);
...
PayPal Security Team',
  'quarantined', 100, 'critical', '["Display name impersonates ''paypal'' but domain is ''paypa1-support.com''.", "Urgency / pressure language: account suspended, act now, expire.", "Requests credentials / sensitive data: confirm your password, verify your identity.", "Link points directly to a raw IP address.", "Link text shows ''www.paypal.com'' but actually points to ''198.51.100.23''.", "Copy uses templated phrasing typical of mass phishing."]', 'fail', 'fail', 'fail', TRUE, (CURRENT_DATE - INTERVAL '5 days' + INTERVAL '12 hours'));
INSERT INTO email_records (message_id, sender, sender_name, recipient, subject, body, status, risk_score, risk_level, score_reasons, auth_spf, auth_dkim, auth_dmarc, templated_language, received_at) VALUES (
...
INSERT INTO email_records (message_id, sender, sender_name, recipient, subject, body, status, risk_score, risk_level, score_reasons, auth_spf, auth_dkim, auth_dmarc, templated_language, received_at) VALUES (
  ...
  'quarantined', 55, 'high', '["Display name impersonates ''microsoft'' but domain is ''micros0ft-alerts.com''.", "Urgency / pressure language: immediately.", "Requests credentials / sensitive data: verify your account.", "References risky attachment type(s): .htm, .html.", "Copy uses templated phrasing typical of mass phishing."]', 'fail', 'fail', 'fail', TRUE, (CURRENT_DATE - INTERVAL '0 days' + INTERVAL '12 hours'));
INSERT INTO email_records (message_id, sender, sender_name, recipient, subject, body, status, risk_score, risk_level, score_reasons, auth_spf, auth_dkim, auth_dmarc, templated_language, received_at) VALUES (
