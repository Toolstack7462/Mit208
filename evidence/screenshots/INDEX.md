...
Captured by `evidence/capture_ci_evidence.py`, which reads the run from the GitHub API and refuses to write anything unless it passed. Run #11 on commit efc09b4, all 6 jobs green.

| File | What it shows |
|---|---|
| `23-ci-run-passing.png` | GitHub Actions run #11 on the public repository, every job green |
| `24-release-tag.png` | The assessed version, tag v1.3-final, on the public repository |
